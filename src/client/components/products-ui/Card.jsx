    ...
    <Link to="/view" state={{ product }}>
      <div className="w-full bg-[#fdfbf7] rounded-xl shadow-sm hover:shadow-lg transition-shadow duration-300 flex flex-col p-0 h-full">
        ...
        <div className="flex flex-col flex-grow px-2 pb-2 justify-between">
          {/* Name */}
          <h2 className="text-sm md:text-lg font-medium line-clamp-1.5 mb-0 min-h-[0.5rem]">
            {name}
          </h2>

          {/* Price and Stock */}
          <div className="flex items-center justify-between mb-0">
            <span className="text-base md:text-lg text-red-950 font-medium font-sans">₹ {price}</span>
